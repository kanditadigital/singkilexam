...
<body>
    <div class="error-container">
        ...
        <p class="error-message">Sesi Anda telah berakhir. Silakan segarkan halaman dan coba lagi.</p>
        <a href="{{ url('/') }}" class="btn-home"><i class="fas fa-sync-alt mr-2"></i> Muat Ulang</a>
    </div>
</body>
</html>
