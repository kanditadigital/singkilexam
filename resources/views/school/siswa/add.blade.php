    ...
    <div class="section-body">
        <div class="card shadow">
            ...
            <div class="card-body mb-0">
                <form action="{{ route('sch.student.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="student_name">Nama Siswa <span class="text-danger">*</span></label>
                            <input type="text" name="student_name" id="student_name" class="form-control @error('student_name') is-invalid @enderror" value="{{ old('student_name') }}" placeholder="Masukkan nama siswa">
                            @error('student_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="student_nisn" id="student_nisn" class="form-control @error('student_nisn') is-invalid @enderror" value="{{ old('student_nisn') }}" placeholder="Masukkan NISN">
                            @error('student_nisn')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
