    ...
    <div class="section-body">
        <div class="card shadow">
            <div class="card-header bg-primary text-white py-1">
                <h4><i class="fas fa-fw fa-list"></i> Tambah Pegawai</h4>
                <div class="ml-auto">
                    <a href="{{ route('pegawai.index') }}" class="btn btn-reka"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
                ...
                <form action="{{ route('pegawai.store') }}" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="employee_name" id="employee_name" class="form-control @error('employee_name') is-invalid @enderror" value="{{ old('employee_name') }}" placeholder="Masukkan nama pegawai">
                            @error('employee_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="employee_phone" id="employee_phone" class="form-control @error('employee_phone') is-invalid @enderror" value="{{ old('employee_phone') }}" placeholder="Masukkan no. telepon">
